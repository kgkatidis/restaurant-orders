...
Στη σελίδα πελάτη, ο σερβιτόρος επιλέγει «Νέο τραπέζι», δίνει τον αριθμό τραπεζιού, και το σύστημα υπολογίζει αυτόματα ολόκληρο τον κωδικό (ελέγχοντας τη βάση για το επόμενο διαθέσιμο ΝΝ) και τον εμφανίζει για να τον δώσει στον πελάτη. Ο πελάτης μπορεί μετά να μπει με «Έχω κωδικό» στο δικό του κινητό.
